...
const hasValidGA = GA_MEASUREMENT_ID !== "G-XXXXXXXXXX" && GA_MEASUREMENT_ID !== "";
const hasValidFB = FB_PIXEL_ID !== "XXXXXXXXXXXXXXX" && FB_PIXEL_ID !== "";
